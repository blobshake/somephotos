...
class BuyersControllerTest < ActionController::TestCase
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post :create, buyer: { email: @buyer.email, name: @buyer.name, photoallowance: @buyer.photoallowance, photocount: @buyer.photocount, username: @buyer.username }
    end
  ...
  test "should update buyer" do
    put :update, id: @buyer, buyer: { email: @buyer.email, name: @buyer.name, photoallowance: @buyer.photoallowance, photocount: @buyer.photocount, username: @buyer.username }
    assert_redirected_to buyer_path(assigns(:buyer))
  end
